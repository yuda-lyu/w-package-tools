...
async function core() {
    ...
    await rollupWorker({
        name: 'gWorker2_Obj', //原模組名稱, 將來會掛於winodw下
    ...
    await rollupWorker({
        name: 'gWorker3_Fun', //原模組名稱, 將來會掛於winodw下
    ...
    await rollupWorker({
        name: 'gWorker4_FunEv', //原模組名稱, 將來會掛於winodw下
        type: 'function', //原模組輸出為函數, 可傳入參數初始化
    ...
    await rollupWorker({
        name: 'gWorker5_FunAsm', //原模組名稱, 將來會掛於winodw下
        type: 'function', //原模組輸出為函數, 可傳入參數初始化
        execFunctionByInstance: false, //原模組為計算函數回傳結果, 故設為false使回傳結果為繼承eventemitter3物件
    ...
    await rollupWorker({
        name: 'gWorker6_ObjStream', //原模組名稱, 將來會掛於winodw下
        type: 'object', //原模組輸出為物件
