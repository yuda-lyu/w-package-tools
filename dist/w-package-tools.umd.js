/*!
 * w-package-tools v1.0.5
 * (c) 2018-2019 yuda-lyu(semisphere)
 * Released under the MIT License.
 */
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('lodash'), require('fs')) :
  typeof define === 'function' && define.amd ? define(['exports', 'lodash', 'fs'], factory) :
  (global = global || self, factory(global['w-package-tools'] = {}, global.lodash, global.fs));
}(this, function (exports, _, fs) { 'use strict';
  ...
  function addVersion() {
    return _addVersion.apply(this, arguments);
  }

  function _addVersion() {
    _addVersion = asyncToGenerator(
    /*#__PURE__*/
      ...
      return regenerator.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              fnPks = _args.length > 0 && _args[0] !== undefined ? _args[0] : './package.json';
              //pks
              pks = getPks(fnPks); //v
  ...
  function modifyReadme() {
    return _modifyReadme.apply(this, arguments);
  }

  function _modifyReadme() {
    _modifyReadme = asyncToGenerator(
    /*#__PURE__*/
    regenerator.mark(function _callee() {
      var fnRM,
          fnPks,
      ...
      return regenerator.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              fnRM = _args.length > 0 && _args[0] !== undefined ? _args[0] : './README.md';
              fnPks = _args.length > 1 && _args[1] !== undefined ? _args[1] : './package.json';
              //pks
              pks = getPks(fnPks); //rdme

              rdme = getReadme(fnRM); //replace

              sf = "(".concat(pks.name, "@)+(\\d+.\\d+.\\d+)");
              sr = "".concat(pks.name, "@").concat(pks.version);
              reg = new RegExp(sf, 'g');
              c = rdme.content.replace(reg, sr); //write
              //console.log(c)
  ...
  exports.modifyReadme = modifyReadme;
  exports.pmSeries = pmSeries;
  exports.setPks = setPks;
